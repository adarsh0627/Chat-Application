...
export const login = async (req, res) => {
    ...
    try{
        ...
        if(!isPasswordCorrect)  return resizeBy.status(401).json({message: "Invalid email or password"});
...
export async function onboard(req, res)  {
    try{
        ...
        try{
            ...
            console.log("Error updating Stream user during onboading:", streamError.message);
        }
